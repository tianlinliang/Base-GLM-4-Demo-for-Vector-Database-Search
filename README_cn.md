...
我们的项目是基于Github开源项目THUDM/GLM-4所进行的项目开发、测试、调试,GLM-4-9B 是智谱 AI 推出的最新一代预训练模型 GLM-4 系列中的开源版本。 在语义、数学、推理、代码和知识等多方面的数据集测评中，**GLM-4-9B** 及其人类偏好对齐的版本 **GLM-4-9B-Chat** 均表现出超越 Llama-3-8B 的卓越性能。除了能进行多轮对话，GLM-4-9B-Chat还支持长文本推理（支持最大 128K 上下文）的高级功能。本代模型增加了多语言支持，支持包括日语，韩语，德语在内的26 种语言。原项目Github地址：https://github.com/THUDM/GLM-4/tree/main
